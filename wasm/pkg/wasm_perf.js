 ...
 * @returns {Int32Array}
 */
export function create_typed_array(length) {
    const ret = wasm.create_typed_array(length);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_perf_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
